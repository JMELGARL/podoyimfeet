  ...
  <body class="hold-transition login-page">
    ...
    <div class="login-box">
      ...
      <div class="login-box-body">
        <p class="login-box-msg">Hola de nuevo!</p>
        <p class="login-box-msg-2">Por favor, ingresa tus credenciales para ingresar a la plataforma</p>
		<?php
